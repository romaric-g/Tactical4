            ...
            <Animatable.View animation={bounceInUp} style={styles.Box}>
                <ScrollView style={styles.Boxscroll}>
                    ...
                    <View style={styles.MessageContainer}>
                        ...
                        <Text style={styles.Paragraphe}>- Être 2 joueurs.</Text>
                        <Text style={styles.Paragraphe}>- Être Connecté sur l'application web, android ou ios.</Text>
                        <Text style={styles.Paragraphe}>- S'être partagé le code partie et s'y être connecté.</Text>
